...
namespace btlquanlysieuthi
{
    public partial class FormC : Form
    {
        ...
        private void LoadNhanVien()
        {
            try
            {
                using (SqlConnection con = new SqlConnection(strCon))
                {
                    ...
                    cbNhanVien.ValueMember = "MaNV";    // Giá trị thực tế là mã để hiện các nhân viên vào combobox
                }
            }
        ...
        }//hmmm hoặc là h có nên viết sql rồi command 1 lần nút thanh toán không nhỉ 
